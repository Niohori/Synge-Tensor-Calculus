...
\vspace{0pt}
%\includegraphics[scale=.5]{p85_ex1.png}
\input{D:/MathLatex/images/fig_p109_Ex5_a.tex}
\end{minipage}\hfill
...
Hence by $(15)$ to $(19)$:
\begin{align}
G^{mn} &= a^{nk} R^m_{. \ k}-\half a^{nk}\delta^m_k R \\
&=  a^{nk} a^{mp} R_{pk}-\half a^{nm}a^{pk}R_{pk} \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)R_{pk} \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\left(\partial_k \Gamma^t_{pt} - \partial_t \Gamma^t_{pk} + \mathcal{F}^{pk}\right) \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\left(\partial_k \Gamma^t_{pt} - \partial_t \Gamma^t_{pk} \right)+ \mathcal{H}^{mn}\\
&= a^{nk} a^{mp}\partial_k \Gamma^t_{pt} -\half a^{nm}a^{pk}\partial_k \Gamma^t_{pt} -  a^{nk} a^{mp}\partial_t \Gamma^t_{pk} +\half a^{nm}a^{pk}\partial_t \Gamma^t_{pk}+ \mathcal{H}^{mn}
\end{align}
...
\begin{align}
\mathcal{H}^{mn} &= \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\mathcal{F}^{pk}\\
\Rightarrow\spatie \mathcal{H}^{nm} &= \left( a^{mk} a^{np} -\half a^{mn}a^{pk}\right)\mathcal{F}^{pk}\\
&= \left( a^{mp} a^{nk} -\half a^{mn}a^{kp}\right)\mathcal{F}^{kp}\\
&= \mathcal{H}^{mn}
\end{align}
...
\cancel{a^{nk} a^{mp}\partial_r \Gamma^t_{st}} -\half a^{nm}a^{rs}\partial_r \Gamma^t_{st} \\\\ 
-  a^{nr} a^{ms}\partial_t \Gamma^t_{rs} +\half a^{nm}a^{rs}\partial_t \Gamma^t_{pk}\\\\
+ a^{mn}a^{rs}\partial_{s}\Gamma^t_{rt}-\cancel{a^{mr}a^{ns}\partial_{s}\Gamma^t_{rt}}\\\\
\end{array} \right. \\
&= \half a^{mn}a^{rs}\partial_{s}\Gamma^t_{rt}+\half a^{nm}a^{rs}\partial_t \Gamma^t_{pk}-  a^{nr} a^{ms}\partial_t \Gamma^t_{rs}
\end{align}
$Q^{mn} $ a symmetrical object in $m,n$
...
And by $3.205.$
\begin{align}
R_{pk} = \half \partial^2_{pk} \ln a -  \partial_t \Gamma^t_{pk} + \mathcal{F}^{pk}
\end{align}
With $\mathcal{F}^{pk}$ a function in  $a_{ij}, a^{ij}, \partial_k a_{ij}, \partial_k a^{ij}$ only. Note that $\mathcal{F}^{pk}$ is a symmetrical object in $p,k$ as $R_{pk}$ is a symmetrical tensor in $p,k$.
Hence by $(15)$ to $(19)$:
\begin{align}
...
&=  a^{nk} a^{mp} R_{pk}-\half a^{nm}a^{pk}R_{pk} \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)R_{pk} \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\left(\half \partial^2_{pk} \ln a -  \partial_t \Gamma^t_{pk} + \mathcal{F}^{pk}\right) \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\left(\half \partial^2_{pk} \ln a -  \partial_t \Gamma^t_{pk} \right)+ \mathcal{H}^{mn}\\
&= \left[ \half a^{nk}a^{mp}\partial^2_{pk} \ln a -  a^{nk}a^{mp}\partial_t \Gamma^t_{pk} -\kwart a^{nm} a^{pk} \partial^2_{pk} \ln a +\half a^{nm} a^{pk}  \partial_t \Gamma^t_{pk} \right]+ \mathcal{H}^{mn}
\end{align}
with $\mathcal{H}^{mn}$ a function in  $a_{ij}, a^{ij}, \partial_k a_{ij}, \partial_k a^{ij}$ only.\\
Note that $\mathcal{H}^{mn}$ is a symmetrical object in $m,n$ . Indeed,
\begin{align}
...
\begin{align}
 Q^{mn} &\equiv \left\{ \begin{array}{l}
\half a^{nr}a^{ms}\partial^2_{rs} \ln a -  a^{nr}a^{ms}\partial_t \Gamma^t_{rs}\\\\ -\kwart a^{nm} a^{rs} \partial^2_{rs} \ln a
+\half a^{nm} a^{rs}  \partial_t \Gamma^t_{rs}\\\\+\half a^{mn}a^{rs}\partial^2_{rs}\ln a-\half a^{mr}a^{ns} \partial^2_{rs}\ln a\\\\
\end{array} \right. \\
&= \kwart a^{mn}a^{rs}\partial^2_{rs}\ln a + \left( \half a^{mn}a^{rs}- a^{ms}a^{nr}\right)\partial_t \Gamma^t_{rs}
\end{align}
Note that 
\begin{align}
 Q^{nm} &= \kwart a^{nm}a^{rs}\partial^2_{rs}\ln a + \left( \half a^{nm}a^{rs}- a^{ns}a^{mr}\right)\partial_t \Gamma^t_{rs} \\
&= \kwart a^{mn}a^{rs}\partial^2_{rs}\ln a + \left( \half a^{mn}a^{rs}- a^{nr}a^{ms}\right)\partial_t \Gamma^t_{sr} \\
&= Q^{mn} 
\end{align}
So $Q^{mn} $ is a symmetrical object in $m,n$
...
\end{align}
with $\mathcal{Z}^{mn} = \kwart a^{mn}a^{rs}\partial_{s} a^{kt}\partial_{r} a_{kt}$ a symmetric object in $m,n$ and depending only on terms in $a_{ij}, a^{ij}, \partial_k a_{ij}, \partial_k a^{ij}$
 
and 
\begin{align}
\mathcal{P}^{mn} = \kwart a^{mn}a^{rs}a^{kt}\partial^2_{rs} a_{kt} + \left( \half a^{mn}a^{rs}- a^{ms}a^{nr}\right)\partial_t \Gamma^t_{rs}
\end{align}
Expanding the Christoffel symbols and playing with the dummy indices, gives
\begin{align}
\mathcal{P}^{mn} &= \left\{\begin{array}{l}\kwart a^{mn}a^{rs}a^{kt}\partial^2_{rs} a_{kt} \\\\
+ \left( \half a^{mn}a^{rs}- a^{ms}a^{nr}\right)\left( [rs,k]\partial_t a^{tk}+ a^{kt}\partial_t[rs,k]\right)
\end{array}\right.\\
&= \half \mathcal{V}^{mn}  +\mathcal{A}^{mn}
\end{align}
with 
\begin{align}
\mathcal{A}^{mn} &= \left( \half a^{mn}a^{rs}- a^{ms}a^{nr}\right) [rs,k]\partial_t a^{tk}
\end{align}
and 
\begin{align}
\half \mathcal{V}_{mn} &= \left\{\begin{array}{l}
\kwart a^{mn}a^{rs}a^{kt}\partial^2_{rs} a_{kt} \\\\
+ \left( \kwart a^{mn}a^{rs} a^{kt}- \half a^{ms}a^{nr} a^{kt}\right)\left( \partial^2_{tr}a_{sk}+\partial^2_{ts}a_{rk}-\partial^2_{tk}a_{rs}\right)
\end{array}\right.\\
&= \left\{\begin{array}{l}
\cancel{\kwart a^{mn}a^{rs}a^{kt}\partial^2_{rs} a_{kt} }
+ \underbrace{\kwart a^{mn}a^{rs} a^{kt} \partial^2_{tr}a_{sk}+ \kwart a^{mn}a^{rs} a^{kt} \partial^2_{ts}a_{rk}}_{= \half a^{mn}a^{rs} a^{kt} \partial^2_{tr}a_{sk}}
- \cancel{\kwart a^{mn}a^{rs} a^{kt} \partial^2_{tk}a_{rs}}\\\\
- \half a^{ms}a^{nr} a^{kt} \partial^2_{tr}a_{sk}
- \half a^{ms}a^{nr} a^{kt} \partial^2_{ts}a_{rk}
+ \half a^{ms}a^{nr} a^{kt} \partial^2_{tk}a_{rs}\\
\end{array}\right.
\end{align}
giving 
\begin{align}
...
&=
 \left( a^{mn}a^{rs}  \partial^2_{tr}a_{sk}
-  a^{ms}a^{nr} \partial^2_{kr}a_{st}
-  a^{ms}a^{nr}  \partial^2_{ts}a_{rk}
+  a^{ms}a^{nr} \partial^2_{tk}a_{rs}\right)a^{kt}\\
&=
 \left( a^{mn}a^{rs}  \partial^2_{tr}a_{sk}
-  a^{ms}a^{nr} \partial^2_{tr}a_{sk}
-  a^{ms}a^{nr}  \partial^2_{tr}a_{sk}
+  a^{ms}a^{nr} \partial^2_{tk}a_{rs}\right)a^{kt}
\end{align}
Does $\mathcal{V}_{mn}$ vanish ?!
...
&= \frac{1}{2a}\left[ a_{|r} \left( a^{mn}a^{rs}-a^{mr}a^{ns} \right)+ a \underbrace{\left( a^{mn}a^{rs}-a^{mr}a^{ns} \right)_{|r}}_{=0}\right] _{|s}\\
&= \frac{1}{2a}\left[ a_{|r} \left( a^{mn}a^{rs}-a^{mr}a^{ns} \right)\right] _{|s}\\
&= \frac{1}{2a}\left[ \underbrace{a_{|rs}}_{=\partial^2_{rs} a+\Gamma^p_{sr} \partial_p a} \left( a^{mn}a^{rs}-a^{mr}a^{ns} \right)+a_{|r} \underbrace{\left( a^{mn}a^{rs}-a^{mr}a^{ns} \right)_{|s}}_{=0} \right]
\end{align}
Considering, 
\begin{align}
\partial^2_{rs} \ln a&= \partial_s \left(\frac{1}{a}\partial_r a\right)\\
...
R_{pk} = \half \partial^2_{pk} \ln a -  \partial_t \Gamma^t_{pk} + \mathcal{F}^{pk}
\end{align}
With $\mathcal{F}^{pk}= \Gamma^i_{pj}\Gamma^j_{kj}-\half\Gamma^i_{pk}\partial_i\ln a$ a function in  $a_{ij}, a^{ij}, \partial_k a_{ij}, \partial_k a^{ij}$ only. Note that $\mathcal{F}^{pk}$ is a symmetrical object in $p,k$ as $R_{pk}$ is a symmetrical tensor in $p,k$.
Hence by $(15)$ to $(19)$:
\begin{align}
G^{mn} &= a^{nk} R^m_{. \ k}-\half a^{nk}\delta^m_k R \\
&=  a^{nk} a^{mp} R_{pk}-\half a^{nm}a^{pk}R_{pk} \\
...
\begin{align}
 Q^{mn} &\equiv \left\{ \begin{array}{l}
\cancel{\half a^{nr}a^{ms}\partial^2_{rs} \ln a} -  a^{nr}a^{ms}\partial_t \Gamma^t_{rs}\\\\ -\kwart a^{nm} a^{rs} \partial^2_{rs} \ln a
+\half a^{nm} a^{rs}  \partial_t \Gamma^t_{rs}\\\\+\half a^{mn}a^{rs}\partial^2_{rs}\ln a-\cancel{\half a^{mr}a^{ns} \partial^2_{rs}\ln a}\\\\
\end{array} \right. \\
&= \kwart a^{mn}a^{rs}\partial^2_{rs}\ln a + \left( \half a^{mn}a^{rs}- a^{ms}a^{nr}\right)\partial_t \Gamma^t_{rs}
\end{align}
Note that 
...
and 
\begin{align}
\half \mathcal{V}^{mn} &= \left\{\begin{array}{l}
\kwart a^{mn}a^{rs}a^{kt}\partial^2_{rs} a_{kt} \\\\
+ \left( \kwart a^{mn}a^{rs} a^{kt}- \half a^{ms}a^{nr} a^{kt}\right)\left( \partial^2_{tr}a_{sk}+\partial^2_{ts}a_{rk}-\partial^2_{tk}a_{rs}\right)
\end{array}\right.\\
&= \left\{\begin{array}{l}
...
We have:
\begin{align}
G^{mn} &= a^{nk}a^{mp}G_{pk}\\
G_{pk} &= R_{pk}-\half a_{pk}R\\
R &= a^{pk}R_{pk}
\end{align}
And by $3.205.$
\begin{align}
...
Hence by $(15)$ to $(19)$:
\begin{align}
G^{mn} &= a^{nk}a^{mp}R_{pk}-\half a^{nk}a^{mp} a_{pk}R \\
&=  a^{nk} a^{mp} R_{pk}-\half a^{nm}a^{pk}R_{pk} \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)R_{pk} \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\left(\half \partial^2_{pk} \ln a -  \partial_t \Gamma^t_{pk} + \mathcal{F}^{pk}\right) \\
&=  \left( a^{nk} a^{mp} -\half a^{nm}a^{pk}\right)\left(\half \partial^2_{pk} \ln a -  \partial_t \Gamma^t_{pk} \right)+ \mathcal{H}^{mn}\\
