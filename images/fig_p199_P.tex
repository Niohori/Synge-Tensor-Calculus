...
\draw[-Latex,very thick](xy)--(nxy);
\coordinate (nxz) at (\aax/3,-5,\ccz/3);
\draw[-Latex,very thick](xz)--(nxz);
\coordinate (nyz) at (-2,\bby/3,\ccz/3);
\draw[-Latex,very thick](yz)--(nyz);
...
\draw[very thick](A)--(O)--(C)--cycle;
\draw[very thick](A)--(O)--(B)--cycle;
\draw[very thick](O)--(B)--(C)--cycle;
