...
\begin{figure}[H]
    \centering
    \subfloat[]{\input{D:/MathLatex/images/fig_p169_Ex_a.tex}}
...
\begin{figure}[H]
\begin{center}
\input{D:/MathLatex/images/fig_p183_5561_a.tex}
...
\begin{figure}[H]
    \centering
    \subfloat[]{\input{D:/MathLatex/images/fig_p188_Ex12_a.tex}}
...
Suppose now that the for $ s\rightarrow +\infty, \quad \int_{0}^{s}dW\rightarrow +\infty$. In that case, the kinetical energy will represent the total energy of the system, $T\rightarrow E$ and $\kappa \rightarrow 0$ for $E\rightarrow +\infty$ provided that $X_r\nu^r\cancel{\rightarrow}\pm \infty$. Consider $\mathbf{5.535}\quad dW=X ds\cos \phi$ where $X$ is the magnitude of the generalized force and $\phi$ the angle between the line of force and the trajectory.
$$\blacklozenge$$
\newpage
