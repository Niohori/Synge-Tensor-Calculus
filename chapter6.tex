...
\begin{align}
\left\{\begin{array}{lll}
\text{6.147}&\frac{\partial v_r}{\partial t}+v^s v_{r|s} = X_r-\rho^{-1}p_{,r}&\text{(a)}\\\\
\text{exercise page 201}&\frac{\partial v^r}{\partial t} + v_s v^{r}_{\ \ |s} = X^r - \rho^{-1} a^{rm}p_{,m}&\text{(b)}
\end{array}\right.
\end{align}
...
giving
\begin{align}
\dv{T}{t} &=-\int_S p v^r n_rdS+\int_R p\theta dV+\int_R \rho X^rv_r dV 
\end{align}
$$\lozenge$$\\\\
