...
\begin{figure}[H]%
    \centering
    \subfloat[]{\input{D:/MathLatex/images/fig_p227_6361_a.tex}}
    \quad
     \subfloat[]{\input{D:/MathLatex/images/fig_p227_6361_b.tex}}
...
\begin{figure}[H]%
    \centering
\input{D:/MathLatex/images/fig_p235_Ex3b.tex}
...
\begin{figure}[H]%
    \centering
\input{D:/MathLatex/images/fig_p235_Ex4a.tex}
...
So, $(18)$ becomes 
\begin{align}
&\epsilon_{pkr}v_{s,k}v_{s,r}+\underbrace{\epsilon_{pkr}v_sv_{s,kr}}_{=0}+2\epsilon_{pkr}\epsilon_{rnm}\left(\omega_nv_m\right)_{,k} =0
\end{align}
From exercise 14 page 141 (see section 4.30 in part I):
$$ \mathbf{\nabla \times  \left( U\times V \right) = V . \nabla U -  U . \nabla V+U\nabla . V-V\nabla.U}$$
\begin{align}
\left(\nabla \times  \left( U\times V \right) \right)_p &\equiv \epsilon_{pkr}\epsilon_{rnm}\left(U_n V_m\right)_{,k}\\
&= V_s U_{s,k} -V_k U_{s,s}+U_k V_{s,s}-U_sV_{k,s}\\
&\equiv V .\nabla U-U .\nabla V+U\nabla .V-V\nabla .U
\end{align}
Putting $U= \overline{\omega}$ and $V= \overline{v}$ :
\begin{align}
 \epsilon_{pkr}\epsilon_{rnm}\left(\omega_n v_m\right)_{,k}
&= v_s \omega_{s,k} -v_k \omega_{s,s}+\omega_k v_{s,s}-\omega_sv_{k,s}
\end{align}
Note that the divergence of the vorticity is zero, so 
\begin{align}
 \epsilon_{pkr}\epsilon_{rnm}\left(\omega_n v_m\right)_{,k}
&= v_s \omega_{s,k}+\omega_k v_{s,s}-\omega_sv_{k,s}
\end{align}
$(24)$ in $(19)$ gives 
\begin{align}
&\epsilon_{pkr}v_{s,k}v_{s,r}+2v_s \omega_{s,k}+2\omega_k v_{s,s}-2\omega_sv_{k,s} =0
\end{align}
